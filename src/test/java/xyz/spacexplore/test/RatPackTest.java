...
public class RatPackTest {
  MainClassApplicationUnderTest appUnderTest =
      new MainClassApplicationUnderTest(SpringBootRatPackApplication.class);

  @Test
  public void whenSayHello_thenGotWelcomeMessage() {
    assertEquals("hello baeldung!", appUnderTest.getHttpClient().getText("/hello"));
  }

  @Test
  public void whenRequestList_thenGotArticles() {
    assertEquals(3, appUnderTest.getHttpClient().getText("/list").split(",").length);
  }
